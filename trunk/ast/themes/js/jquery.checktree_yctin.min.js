        ...
        $tree.update=function(){
            ...
            $tree.find("li").each(function(){
                if(jQuery(this).is(":has(ul)")){
                    ...
                    if($input_checkbox_checked.length==0){
                        $checkbox.removeClass("checked half_checked").siblings(":checkbox").attr("checked",false);
                    }else if($input_checkbox.length==$input_checkbox_checked.length){
                        $checkbox.removeClass("half_checked").addClass('checked').siblings(":checkbox").attr("checked",true);
                    }else{
                        $checkbox.removeClass("checked").addClass('half_checked').siblings(":checkbox").attr("checked",settings.attrHalfChecked);
                    }
                }
            });
        };

        $tree.find("li").find(":checkbox").change(function(){
            var $all=jQuery(this).siblings("ul").find(":checkbox");
            var $checked=$all.filter(":checked");
            if($all.length==$checked.length){
                jQuery(this).attr("checked",true).siblings(".checkbox").removeClass("half_checked").addClass("checked");
                if(settings.onCheck)settings.onCheck(jQuery(this).parent());
            }else if($checked.length==0){
                jQuery(this).attr("checked",false).siblings(".checkbox").removeClass("checked").removeClass("half_checked");
                if(settings.onUnCheck)settings.onUnCheck(jQuery(this).parent());
            }else{
                if(settings.onHalfCheck&&!jQuery(this).siblings(".checkbox").hasClass("half_checked"))settings.onHalfCheck(jQuery(this).parent());
            ...
            if(jQuery(this).is(":has(ul)")){
                if(jQuery(this).children("ul").is(":hidden"))$arrow.addClass("collapsed");else $arrow.addClass("expanded");
            ...
            $checkbox.click(function(){
                jQuery(this).toggleClass("checked").removeClass("half_checked").siblings(":checkbox").attr("checked",(jQuery(this).hasClass("checked")?true:false));
                if(jQuery(this).hasClass("checked")){
                    if(settings.onCheck)settings.onCheck(jQuery(this).parent());
                    jQuery(this).siblings("ul").find(".checkbox").not(".checked").removeClass("half_checked").addClass("checked").each(function(){
                        if(settings.onCheck)settings.onCheck(jQuery(this).parent());
                    }).siblings(":checkbox").attr("checked",true);
                }else{
                    if(settings.onUnCheck)settings.onUnCheck(jQuery(this).parent());
                    jQuery(this).siblings("ul").find(".checkbox").filter(".checked").removeClass("half_checked").removeClass("checked").each(function(){
                        if(settings.onUnCheck)settings.onUnCheck(jQuery(this).parent());
            ...
            if(jQuery(this).children('.checkbox').hasClass('checked'))$checkbox.addClass('checked');
                ...
                jQuery(this).parents("ul").siblings(":checkbox").change()
            }else if(jQuery(this).children('.checkbox').hasClass('half_checked'))$checkbox.addClass('half_checked');
